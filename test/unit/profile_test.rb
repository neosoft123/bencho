...
class ProfileTest < ActiveSupport::TestCase
  ...
  context 'A Profile instance' do
    ...
    should_have_many :kontacts
    should_have_many :kontact_informations, :through => :kontacts
  ...
  context('A new profile') do
    should 'create an associated profile information' do
      p = Profile.find_or_create_by_email 'john@doe.com'
      ...
      assert_not_nil p.kontact_information
    end
  end
